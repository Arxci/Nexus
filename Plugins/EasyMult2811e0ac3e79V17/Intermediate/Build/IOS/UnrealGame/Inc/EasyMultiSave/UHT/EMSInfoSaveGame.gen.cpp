...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEMSInfoSaveGame_Statics::NewProp_SlotInfo = { "SlotInfo", nullptr, (EPropertyFlags)0x0010000001000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEMSInfoSaveGame, SlotInfo), Z_Construct_UScriptStruct_FSaveSlotInfo, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SlotInfo_MetaData), NewProp_SlotInfo_MetaData) }; // 2693035065
...
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Common_Public_EMSInfoSaveGame_h__Script_EasyMultiSave_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEMSInfoSaveGame, UEMSInfoSaveGame::StaticClass, TEXT("UEMSInfoSaveGame"), &Z_Registration_Info_UClass_UEMSInfoSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEMSInfoSaveGame), 3398482741U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Common_Public_EMSInfoSaveGame_h__Script_EasyMultiSave_2566234038{
